...
public class CombatBuilder {
	...
	public CombatBuilder(CharacterEntity entity) {
	 ...
	 */
	public void addDamage(CharacterEntity entity, int amount) {
	...
	public CharacterEntity getVictim() {
		return victim;
	}

	public void setVictim(CharacterEntity victim) {
		this.victim = victim;
	}
	...
	public CharacterEntity getLastAttacker() {
		return lastAttacker;
	}
	
	public void setLastAttacker(CharacterEntity lastAttacker) {
