...
public class PlayerPunishment {
	...
	public static void init() {
		initializeList(GameSettings.SANCTION_DIRECTORY, "IPBans", IPSBanned);
		initializeList(GameSettings.SANCTION_DIRECTORY, "Bans", AccountsBanned);
		initializeList(GameSettings.SANCTION_DIRECTORY, "IPMutes", IPSMuted);
		initializeList(GameSettings.SANCTION_DIRECTORY, "Mutes", AccountsMuted);
		initializeList(GameSettings.SANCTION_DIRECTORY, "TempMutes", AccountsTempMuted);
	}

	public static void initializeList(String directory, String file, ArrayList<String> list) {
		try {
            FileUtils.createNewFile(directory, file + ".txt");
	...
	public static void addBannedIP(String IP) {
		if(!IPSBanned.contains(IP)) {
			addToFile(GameSettings.SANCTION_DIRECTORY + "IPBans.txt", IP);
			IPSBanned.add(IP);
		}
	}
	...
	public static void addMutedIP(String IP) {
		if(!IPSMuted.contains(IP)) {
			addToFile(GameSettings.SANCTION_DIRECTORY + "IPMutes.txt", IP);
			IPSMuted.add(IP);
		}
	}
	...
	public static void ban(String p) {
		...
		if(!AccountsBanned.contains(p)) {
			addToFile(GameSettings.SANCTION_DIRECTORY + "Bans.txt", p);
	...
	public static void mute(String p) {
		...
		if(!AccountsMuted.contains(p)) {
			addToFile(GameSettings.SANCTION_DIRECTORY + "Mutes.txt", p);
			AccountsMuted.add(p);
		}
	}
	...
	public static void tempMute(String p) {
		...
		if(!AccountsTempMuted.contains(p)) {
			addToFile(GameSettings.SANCTION_DIRECTORY + "TempMutes.txt", p);
...
/*	public static void tempmute(String p, int q) {
	...
	public static void unban(String player) {
		player = Misc.formatPlayerName(player.toLowerCase());
		deleteFromFile(GameSettings.SANCTION_DIRECTORY + "Bans.txt", player);
		AccountsBanned.remove(player);
	}

	public static void unmute(String player) {
		player = Misc.formatPlayerName(player.toLowerCase());
		deleteFromFile(GameSettings.SANCTION_DIRECTORY + "Mutes.txt", player);
		AccountsMuted.remove(player);
	}
	
	public static void unTempMute(String player) {
		player = Misc.formatPlayerName(player.toLowerCase());
		deleteFromFile(GameSettings.SANCTION_DIRECTORY + "TempMutes.txt", player);
