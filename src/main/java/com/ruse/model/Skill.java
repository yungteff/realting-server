...
public enum Skill {
	...
	Skill(int chatboxInterface, int prestigePoints, int prestigeId, int skillCapeId, int skillCapeTrimmedId, int petid, int funExperienceModifier, int easyExperienceModifier, int regularExperienceModifier, int hardExperienceModifier, int extremeExperienceModifier, int modernExperienceModifier) {
