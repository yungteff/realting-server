...
public enum PlayerRights {
	...
	PLAYER(-1, null, 1), // A regular muggle.
	MODERATOR(-1, "<col=20B2AA><shad=0>", 1), // A moderator who has more privilege than other regular members and donators.
	ADMINISTRATOR(-1, "@yel@<shad=0>", 1), // The second-highest-privileged member of the server.
	OWNER(-1, "<col=B40404><shad=0>", 1), // The highest-privileged member of the server
	DEVELOPER(-1, "<col=0><shad=B40404>", 1),
	VETERAN(-1, "<col=0><shad=FF7F00>", 1),
	CONTRIBUTOR(-1, "<col=424242><shad=0>", 1),
	MEMBER(-1, "<col=FED439><shad=0>", 1),
	...
	public double getExperienceGainModifier(Skill skill) {
		int nonCombat = 35;
		int combat = 100;
		switch (skill) {
			case ATTACK:
