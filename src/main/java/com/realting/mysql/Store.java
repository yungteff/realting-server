...
public class Store implements Runnable {
	...
	public static final String HOST = "kandarin.org"; // website ip address
	public static final String USER = "kandarin_store_u";
	public static final String PASS = "wKeYwBv69Zl8LLs!";
	public static final String DATABASE = "kandarin_store_u";
