package com.realting.world.content.combat.range;
...
public class DwarfMultiCannon {
	...
	public static void attack(Player player) { //TODO: Bad hardcoding of setting damage, switch to combathittask 
		...
		if(n == null)
			return;
		Hit dmg = new Hit(player, Misc.getRandom(266) - Misc.getRandom(n.getDefinition().getDefenceRange()), Hitmask.RED, CombatIcon.RANGED);
