...
import com.realting.world.content.skill.herblore.Herblore;
import com.realting.world.content.skill.herblore.ingredientsBook;
import com.realting.world.content.skill.hunter.BoxTrap;
import com.realting.world.content.skill.hunter.Hunter;
import com.realting.world.content.skill.hunter.JarData;
import com.realting.world.content.skill.hunter.PuroPuro;
import com.realting.world.content.skill.hunter.SnareTrap;
import com.realting.world.content.skill.hunter.Trap.TrapState;
import com.realting.world.content.skill.prayer.Prayer;
import com.realting.world.content.skill.runecrafting.Runecrafting;
import com.realting.world.content.skill.runecrafting.RunecraftingPouches;
import com.realting.world.content.skill.runecrafting.RunecraftingPouches.RunecraftingPouch;
import com.realting.world.content.skill.slayer.SlayerDialogues;
...
import com.realting.world.content.skill.woodcutting.BirdNests;
...
public class ItemActionPacketListener implements PacketListener {
	...
	public void thirdClickAction(Player player, Packet packet) {
		...
		case 9003:
			...
			NpcItemDropping.sendDropTableInterface(player, player.getLastTomed());
			player.getClickDelay().reset();
			break;
		//case 13738:
		case 13740:
